...
def create_payment_session(order, user_email, request):
    ...
    try:
        ...
        for item in order.items:
            # Tırnak işaretlerini temizle, fiyatı 10.00 formatına getir
        ...
        # KRİTİK DÜZELTME: separators=(',', ':') boşlukları siler. 
        # PHP'deki json_encode ile birebir aynı çıktıyı verir.
        ...
        # 4. TOKEN OLUŞTURMA: Sıralama asla değiştirilemez.
        hash_str = (
            str(MERCHANT_ID) +
            user_ip +
            oid +
