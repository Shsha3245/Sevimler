        ...
        <div className="space-y-8 text-stone-600 text-sm leading-relaxed font-medium">
          ...
          <section className="space-y-3">
            ...
            <div className="bg-stone-50 p-4 rounded-xl border border-stone-100 space-y-4">
              <div>
                <p className="text-[#d97706] text-xs font-black uppercase tracking-widest">SATICI BİLGİLERİ (Aşağıdaki alanları resmi bilgilerinizle doldurun):</p>
                <p className="mt-1"><strong>Ünvanı:</strong> Sevimler Kuruyemiş - [Resmi Ad Soyad veya Şirket Tam Adı]</p>
                <p><strong>Adresi:</strong> [Vergi Levhasındaki Resmi Dükkan Adresi] Bornova / İzmir</p>
                <p><strong>Telefon:</strong> 0 (507) 105 84 27</p>
          ...
          <section className="space-y-3">
            ...
            <p>
              Mal ya da ürünlerin türü, miktarı, marka/modeli, adedi, satış bedeli, ödeme şekli, siparişin sonlandığı andaki bilgilerden oluşmaktadır. Alışveriş sırasında belirtilen kargo ücreti ALICI tarafından karşılanır ve sipariş toplam tutarına eklenir. Ödemeler <strong>PayTR</strong> güvenli ödeme altyapısı aracılığıyla kredi kartı veya banka kartı ile tahsil edilir.
            </p>
          </section>
